...
function saveUserFile(_0) {
  return __async$9(this, arguments, function* ({
    ...
    yield promises.writeFile(filePath, dataString);
  });
}
...
function parseRecoveryKey(value) {
  if (!value) {
    throw new commander.InvalidArgumentError("Invalid Recovery Key");
  }
  try {
    ethers.computeAddress("0x" + value);
  } catch (e) {
    throw new commander.InvalidArgumentError("Invalid Recovery Key");
  }
  return value;
...
exports.parseRecoveryKey = parseRecoveryKey;
